    ...
    <section class="rounded-lg bg-neutral-50 shadow-lg p-6 max-w-[95%] mx-auto mt-10 fade-in">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">Товары в корзине (<?php echo e($cartItems->sum('quantity')); ?>)</h2>
            </div>
                ...
                <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-6 flex items-center space-x-4">
                        ...
                        <div class="flex-shrink-0">
                            <?php if($item->product->mainImage): ?>
                                <img src="<?php echo e($item->product->mainImage->image_url); ?>" 
                                     alt="<?php echo e($item->product->name); ?>" 
                                     class="w-20 h-20 object-cover rounded-lg">
                            <?php elseif($item->product->picture): ?>
                                <img src="<?php echo e(asset('storage/' . $item->product->picture)); ?>" 
                                     alt="<?php echo e($item->product->name); ?>" 
                                     class="w-20 h-20 object-cover rounded-lg">
                            <?php else: ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-medium text-gray-900 truncate"><?php echo e($item->product->name); ?></h3>
                            <?php if($item->size): ?>
                                <p class="text-sm text-gray-500">Размер: <?php echo e($item->size); ?></p>
                            <?php endif; ?>
                            <p class="text-sm text-gray-600">Цена: <?php echo e(number_format($item->price, 2, ',', ' ')); ?> руб</p>
                        </div>
                        ...
                        <div class="text-right">
                            <p class="text-lg font-semibold text-gray-900"><?php echo e(number_format($item->price * $item->quantity, 2, ',', ' ')); ?> руб</p>
                        </div>
        ...
        <div class="bg-gray-50 mt-6">
            <div class="flex justify-between items-center">
                ...
                <span class="text-2xl font-bold text-cyan-700"><?php echo e(number_format($total, 2, ',', ' ')); ?> руб</span>
            </div>
...
<?php echo $__env->make('layouts.tall', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel\resources\views/cart.blade.php ENDPATH**/ ?>