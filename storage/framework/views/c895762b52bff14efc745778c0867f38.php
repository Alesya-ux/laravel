        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <!-- Навигационные ссылки можно добавить здесь при необходимости -->
                </div>
            </div>
...
<?php endif; ?>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <!-- Мобильные навигационные ссылки можно добавить здесь при необходимости -->
        </div>
...
<?php /**PATH C:\laragon\www\laravel\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>