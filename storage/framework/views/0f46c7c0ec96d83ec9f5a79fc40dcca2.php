<?php $__env->startSection('content'); ?>
    ...
    <main>
        <div class = "p-6 ">
            <h1 class="text-3xl font-semibold"> <?php echo e($product->name); ?> </h1>
        </div>
        ...
        <section class="rounded-lg bg-neutral-50 shadow-lg p-10 max-w-[95%] mx-auto mb-8 fade-in">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
                ...
                <div class="flex justify-center items-center   p-3 rounded-2xl h-full">
                    <div class="relative w-full max-w-md">
                        <!-- Главное изображение -->
                        <div class="relative overflow-hidden rounded-lg shadow-lg bg-gray-50 p-2 mb-4">
                            <a href="<?php echo e($product->main_image_url); ?>" class="block h-80 rounded-md overflow-hidden" id="main-image-link">
                        ...
                        <?php if($product->hasAdditionalImages() || $product->images->count() > 1): ?>
                        <div class="grid grid-cols-3 gap-3">
                            <?php $__currentLoopData = $product->getAllImagesOrdered(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative group cursor-pointer transition-all duration-300 <?php echo e($index === 0 ? 'ring-2 ring-red-500 ring-offset-1' : 'hover:ring-2 hover:ring-red-300 hover:ring-offset-1'); ?>"
                                     onclick="changeMainImage('<?php echo e($image->image_url); ?>', '<?php echo e($image->alt_text ?: $product->name); ?>')">
                ...
                <div class="shadow-2xl  bg-white p-6 rounded-2xl h-full">
                    <!-- Название продукта -->
                    ...
                    <div class="mb-6">
                        <div class="text-3xl font-bold text-red-600 mb-1" id="current-price">
                            <?php if(count($sizes_with_prices) > 0): ?>
                                <?php echo e(number_format(array_values($sizes_with_prices)[0], 2, ',', ' ')); ?> руб
                            <?php else: ?>
                    ...
                    <div class="mb-6">
                        ...
                        <select id="sizes-dropdown" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200 bg-white">
                            <?php $__currentLoopData = $size_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const sizesWithPrices = <?php echo json_encode($sizes_with_prices, 15, 512) ?>;
...
<?php echo $__env->make('layouts.tall', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel\resources\views/product.blade.php ENDPATH**/ ?>